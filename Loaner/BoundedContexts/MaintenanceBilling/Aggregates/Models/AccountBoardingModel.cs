...
namespace Loaner.BoundedContexts.MaintenanceBilling.Aggregates.Models
{
    public class AccountBoardingModel
    {
        ...
        {
            return $"{nameof(LastPaymentAmount)}: {LastPaymentAmount}, {nameof(LastPaymentDate)}: {LastPaymentDate}, {nameof(PortfolioName)}: {PortfolioName}, {nameof(AccountNumber)}: {AccountNumber.Instance}, {nameof(OpeningBalance)}: {OpeningBalance}, {nameof(Inventory)}: {Inventory}, {nameof(UserName)}: {UserName}";
        }
    }
}